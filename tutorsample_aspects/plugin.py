...
hooks.Filters.CONFIG_DEFAULTS.add_items(
    [
        ...
        # Prefix your setting names with 'SAMPLE_ASPECTS_'.
        ("SAMPLE_ASPECTS_VERSION", __version__),
    ]
)
...
hooks.Filters.CONFIG_UNIQUE.add_items(
    [
        ...
        # Prefix your setting names with 'SAMPLE_ASPECTS_'.
        # For example:
        ### ("SAMPLE_ASPECTS_SECRET_KEY", "{{ 24|random_string }}"),
    ]
)
...
#   $ tutor local do say-hi --name="Sara Burns"
